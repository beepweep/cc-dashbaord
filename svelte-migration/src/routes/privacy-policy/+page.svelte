<main class="min-h-screen bg-white py-20 px-3 sm:px-5 lg:px-7">
    <div class="max-w-2xl mx-auto prose prose-slate">
        <h1 class="text-2xl font-bold text-slate-900 mb-7">Privacy Policy</h1>
        <p class="text-slate-600 mb-3">Last updated: December 6, 2025</p>

        <h2 class="text-xl font-semibold text-slate-900 mt-8 mb-4">
            1. Introduction
        </h2>
        <p class="text-slate-600 mb-4">
            Welcome to Cardforyou. We respect your privacy and are committed to
        ...
        <ul class="list-disc pl-5 text-slate-600 mb-4 space-y-2">
            <li>
