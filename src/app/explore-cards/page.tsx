                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {sortedCards.map((card) => (
                        ...
                        >
                            ...
                            <div className="relative bg-slate-100 overflow-hidden p-4">
                                {/* Card Visual */}
                                <div className="relative w-full aspect-[1.586/1] rounded-xl overflow-hidden shadow-lg transform group-hover:scale-105 group-hover:-rotate-1 transition-all duration-500">
                                    <Image
                                        src={card.image}
                                        alt={card.name}
                                        fill
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex flex-wrap gap-1.5 mb-5">
                                    {card.features.slice(0, 2).map((feature: string, idx: number) => (
                                        <span
                                            key={idx}
