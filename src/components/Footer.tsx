    ...
    return (
        <footer className="bg-black text-slate-300 py-10 border-t border-slate-900">
            <div className="max-w-6xl mx-auto px-3 sm:px-5 lg:px-7">
                <div className="flex flex-col md:flex-row justify-between gap-7 mb-10">
                ...
                <div className="pt-7 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-5">
                ...
                <div className="mt-7 pt-7 border-t border-slate-900 text-center">
