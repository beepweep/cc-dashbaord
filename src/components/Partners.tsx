        ...
        <section className="relative bg-gradient-to-b from-white via-slate-50 to-white py-20 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-5 lg:px-6 relative z-10">
                ...
                <div className="mt-12 text-center">
                    <Link
                        href="/explore-cards"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 text-white font-semibold rounded-full hover:bg-slate-800 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl text-sm"
                    >
                        View All Cards
