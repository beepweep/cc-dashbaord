...
<footer class="bg-black text-slate-300 py-10 border-t border-slate-900">
    <div class="max-w-6xl mx-auto px-3 sm:px-5 lg:px-7">
            ...
            <div class="max-w-sm">
                <div class="flex items-center gap-2.5 mb-3">
                    ...
                    <div class="relative w-8 h-8 flex items-center justify-center">
                        <div class="absolute w-5 h-5 bg-white/10 rounded-md transform -rotate-12 translate-x-0.5 translate-y-0.5 backdrop-blur-sm border border-white/10"></div>
                        <div class="absolute w-5 h-5 bg-white rounded-md transform rotate-6 border border-white/50 shadow-lg"></div>
                    </div>
                    <span class="text-lg font-bold text-white tracking-tight">Cardforyou</span>
                </div>
        ...
        <div class="pt-7 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-5">
            <p class="text-[10px] text-slate-600 order-3 md:order-1">
                &copy; {currentYear} Cardforyou. All rights reserved.
            </p>

            <div class="flex flex-col md:flex-row items-center gap-5 order-1 md:order-2">
                <div class="flex flex-wrap justify-center gap-5 text-[10px] text-slate-500 font-medium order-2 md:order-1">
                    <a href="/media-kit" class="hover:text-white transition-colors">Media Kit</a>
                    <a href="/privacy-policy" class="hover:text-white transition-colors">Privacy Policy</a>
                    <a href="/terms-of-use" class="hover:text-white transition-colors">Terms of Use</a>
                ...
                <div class="flex gap-3 order-1 md:order-2">
                    ...
                    <a href="#" class="text-slate-500 hover:text-white transition-colors">
                        ...
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" /></svg>
                    </a>
                </div>
            </div>
        </div>
        <div class="mt-7 pt-7 border-t border-slate-900 text-center">
            <p class="text-[5px] text-slate-700 max-w-3xl mx-auto leading-relaxed uppercase tracking-wider">
