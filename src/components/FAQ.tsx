...
export default function FAQ() {
    ...
    return (
        <section className="relative bg-gradient-to-b from-black via-slate-950 to-black py-28 px-3 sm:px-5 lg:px-7 overflow-hidden">
            {/* Animated background elements */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/4 -left-28 w-56 h-56 bg-blue-500/20 rounded-full blur-[86px] animate-pulse" />
                <div className="absolute bottom-1/4 -right-28 w-56 h-56 bg-purple-500/20 rounded-full blur-[86px] animate-pulse" style={{ animationDelay: '1.5s' }} />
            </div>
            ...
            <div className="max-w-3xl mx-auto relative z-10">
                ...
                <div className="text-center mb-14">
                    <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-5">
                ...
                <div className="space-y-3">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            >
                                <span className={`text-base font-semibold pr-7 transition-all duration-300 ${openIndex === index
                                    ? 'text-white'
                ...
                <div className="mt-14 text-center">
                    <div className="inline-flex flex-col items-center p-7 rounded-2xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/10 backdrop-blur-sm">
                        <p className="text-base text-white/60 mb-3">Still have questions?</p>
                        <a
                            href="#"
                            className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-white text-slate-900 font-semibold rounded-full hover:bg-white/90 hover:scale-105 transition-all duration-300 shadow-lg shadow-white/10 text-sm"
                        >
