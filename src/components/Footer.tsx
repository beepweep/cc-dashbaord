...
export default function Footer() {
    ...
    return (
        <footer className="bg-black text-slate-300 py-12 border-t border-slate-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-md">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className="relative w-10 h-10 flex items-center justify-center">
                                <div className="absolute w-6 h-6 bg-white/10 rounded-lg transform -rotate-12 translate-x-1 translate-y-1 backdrop-blur-sm border border-white/10"></div>
                                <div className="absolute w-6 h-6 bg-white rounded-lg transform rotate-6 border border-white/50 shadow-lg"></div>
                            </div>
                            <span className="text-xl font-bold text-white tracking-tight">Cardforyou</span>
                        </div>
                ...
                <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-xs text-slate-600 order-3 md:order-1">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 order-1 md:order-2">
                        <div className="flex flex-wrap justify-center gap-6 text-xs text-slate-500 font-medium order-2 md:order-1">
                ...
                <div className="mt-8 pt-8 border-t border-slate-900 text-center">
                    <p className="text-[6px] text-slate-700 max-w-4xl mx-auto leading-relaxed uppercase tracking-wider">
